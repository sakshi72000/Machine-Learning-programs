...
def MarvellousKNeighbor():
  ...
  print("Size of Trainng data set %d"%(i+1))

  print(border)
  print("Test data set")
  print(border)
  for i in range(len(data_test)):
   print("ID:%d,Label %s,Feature: %s"%(i,data_train[i],target_test[i]))
...
def main():
 ...
 print("Accuracy of classification algorithm with K Neighbor classifier is",Accuracy)
